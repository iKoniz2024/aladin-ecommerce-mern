      ...
      <div className="rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="flex size-14 items-center justify-center rounded-2xl bg-[#0B3C73] text-[#FFA800] font-black text-xl shadow-md">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#0B3C73] px-5 py-2.5 text-xs font-bold text-white shadow-md hover:bg-[#082d56] transition-all hover:scale-102"
            >
              <ShoppingBag className="size-4 text-[#FFA800]" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/dashboard/products" className="block rounded-2xl border border-border bg-card p-5 shadow-2xs hover:shadow-md transition-all group">
          <div className="flex items-center justify-between">
            ...
            <div className="flex size-9 items-center justify-center rounded-xl bg-purple-500/10 text-purple-600 group-hover:scale-105 transition-transform">
              ...
              <tbody className="divide-y divide-border">
                {orders.map((order) => (
                  <tr key={order._id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className="inline-flex items-center gap-1 rounded-full bg-blue-500/10 text-blue-600 px-2.5 py-1 text-[11px] font-bold capitalize border border-blue-500/20">
